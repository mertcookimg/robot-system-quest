...
const JAPANESE_STAGE_LABELS: Readonly<Record<string, JapaneseStageLabel>> = {
  ...
  lidar_explorer: { name: "LiDAR探索", lesson: "障害物を避けながらフィールドを探索する" },
  ...
  robo_kitchen: { name: "ロボキッチン", lesson: "ロボットアームで食材を調理する" },
  swarm_rescue: { name: "群ロボット救助隊", lesson: "複数のロボットで協力して救助する" },
  robo_baseball: { name: "ロボ野球", lesson: "投球を予測してタイミングよく打つ" },
  robo_tennis: { name: "ロボテニス", lesson: "ボールの高さと着地点を予測して返球する" },
  ...
  lidar_avoidance: { name: "LiDAR障害物回避", lesson: "距離センサーを使った反応走行" },
  param_tuner: { name: "パラメータ調整", lesson: "ROS 2パラメータ" },
